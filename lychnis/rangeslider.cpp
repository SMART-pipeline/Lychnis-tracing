...
const int scSliderBarHeight = 20;
...
RangeSlider::RangeSlider(QWidget* aParent)
    : QWidget(aParent),
      ...
      mBackgroudColorEnabled(QColor(81,83,84,70)),
...
void RangeSlider::paintEvent(QPaintEvent* aEvent)
{
    ...
    QBrush handleBrush(QColor(152,152,152,100));
...
void RangeSlider::setLowerValue(int aLowerValue)
{
    if(mLowerValue==aLowerValue){return;}
...
void RangeSlider::setUpperValue(int aUpperValue)
{
    if(mUpperValue==aUpperValue){return;}
